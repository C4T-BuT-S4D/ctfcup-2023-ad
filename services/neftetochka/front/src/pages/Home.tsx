...
function HomePage(prop: {stations: StationResponse}) {
  ...
  return (
    <div className='bg-gradient-to-br from-[#151515] to-[#440857] from-20% w-max h-max p-10 flex gap-10'>
      ...
      <div className='rounded-3xl bg-gradient-to-br from-[#151515] to-[#440857] from-20% to-80% w-[420px] p-6 space-y-5'>
        ...
        {!sending ? <></> :
        <div className={`rounded-xl ${sendOk === true ? 'bg-green-500' : sendNoMoney != null ? 'bg-red-500' : 'bg-purple-900'} p-4 text-white`}>
          ...
          <div className='mt-3 flex gap-3'>
            <button onClick={() => callApiAddMoney()} className='rounded-3xl bg-white p-2 text-black flex-1'>Add money</button>
            <button onClick={() => leaveNoMoney()} className='flex-1'>Leave</button>
          </div></>}
          ...
          {lastReceived.data?.map((oil, i) => <>
            <div className='font-[600] text-[16px] gap-4'>
              <div className='flex'>
                ...
                <div className='italic'>{oil.sender}</div>
              </div>
              <div className='flex'>
              ...
              <div className='flex'>
                ...
                <div className='italic'>{oil.message}</div>
              </div>
            </div>
